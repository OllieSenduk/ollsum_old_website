      ...
      <div class="space-guy__container">
        ...
        <svg class="rocketManSVG" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" x="0px" y="0px" viewBox="0 0 600 600" xml:space="preserve">
          ...
          <g class="astronaut">
            ...
            <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="220px" y="60px"
            ...
            <ellipse transform="matrix(0.1252 -0.9921 0.9921 0.1252 -124.251 546.2404)" style="fill:#FCD690;" cx="247.628" cy="343.578" rx="102.926" ry="110.766"/>
            <g>
            ...
            <g>
            		...
            		<ellipse transform="matrix(0.0543 -0.9985 0.9985 0.0543 12.4637 373.7843)" style="fill:#FF91AB;" cx="203.564" cy="180.312" rx="27.189" ry="34.149"/>

            		<ellipse transform="matrix(-0.0543 0.9985 -0.9985 -0.0543 599.5518 -187.1638)" style="fill:#FF91AB;" cx="388.407" cy="190.335" rx="27.189" ry="34.149"/>
            </g>
